...
A solution to the BSDE is a pair of processes $(Y,Z) \in \mathbb{S}^2([0,T];\mathbb{R}) \times \mathbb{H}^2([0,T]; \mathbb{R}^d)$ satisfying
$$
\begin{align}
...
\end{align}
$$
<span class="para-subtitle">Link between $v$ and $(Y,Z)$ :</span>
