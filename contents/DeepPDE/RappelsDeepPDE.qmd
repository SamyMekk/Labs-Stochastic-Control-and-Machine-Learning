...
<span class="para-title">Mathematical description : </span>

:::


::: {#alg-description .algorithm}
<span class="para-title">Deep Galerkin Algorithm : </span>
...
::: {#alg-description .algorithm}
<span class="para-title">Deep BSDE Algorithm : </span>
...
::: {#alg-description .algorithm}
<span class="para-title">Deep BDP Algorithm : </span>
